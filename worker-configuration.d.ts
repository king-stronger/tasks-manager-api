/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 57f2a91d336dcfe7beeb46bf3f3134dc)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOG_LEVEL" | "DATABASE_URL">> {}
}
